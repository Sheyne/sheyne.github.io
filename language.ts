...
type Result = string | number | boolean | Lambda | DeadResult;
type LispInfo = {
    results: Map<LispFunction, Result>;
};
interface Lambda {
    (args: LispFunction[], context: Context, info: LispInfo): Result;
    numArgs?: number;
}
...
function evalnumber(e: LispFunction, context: Context, info: LispInfo, message: string) {
...
function binaryMath(op: (a: number, b: number) => number | boolean, args: LispFunction[], context: Context, info: LispInfo, name: string) {
    const res = 0;
    if (args.length != 2) {
...
function calllisp(func: Result, args: LispFunction[], context: Context, info: LispInfo) {
...
function evalf(args: LispFunction[], context: Context, info: LispInfo) {
...
function lookup(name: string, context: Context, info: LispInfo) {
...
function evallisp(el: LispFunction, context: Context, info: LispInfo) {
    let res;
